...
void buzzCmd(WebServer &server, WebServer::ConnectionType type, char *url_tail, bool tail_complete)
{
  ...
  if (type == WebServer::GET)
  {
    ...
    P(message) = 
      ...
      "<p style='margin: 40px;'><button name='hcs' value='5' style='width: 100%;height: 10%;font-family: monospace;font-size: 35px;'>Portão ( Abrir / Fechar )</button></p>"
      "<p style='margin: 40px;'><button name='hcs' value='6' style='width: 100%;height: 10%;font-family: monospace;font-size: 35px;'>Ligar Alarme</button></p>"
      "<p style='margin: 40px;'><button name='hcs' value='7' style='width: 100%;height: 10%;font-family: monospace;font-size: 35px;'>Desligar Alarme</button></p>"
      "</form></body></html>";
